...
import { AllCategoryApi, AvideoApi, addCategoryApi, deleteCategoryApi, updateCategoryApi } from '../sevices/allApi';
...
function Category({dragStatus,setDragStatus}) {
  ...
  const DragStart =(e,videoId,categoryId)=>{
    ...
    e.dataTransfer.serData("dataShared",JSON.stringify(dataShare))
  }
